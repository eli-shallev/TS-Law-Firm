          ...
          <div className="grid grid-cols-1 gap-12 md:gap-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start mt-4 md:mt-8 text-right">
              ...
              <div className="space-y-4 md:space-y-6 flex flex-col items-start">
                ...
                <p className="font-sans text-sm md:text-base text-gray-600 leading-relaxed text-justify">
                  אנו מבינים שהליך משפטי עשוי להיות מורט עצבים ומלווה בחוסר ודאות. לכן, הליווי של שני הוא צמוד ואישי, מתוך מחויבות למקצועיות ללא פשרות ושקיפות מלאה מול הלקוח. המטרה שלנו היא אחת: להוвать עבורכם עוגן איתן, להילחם על זכויותיכם בנחישות, ולהוביל אתכם לפתרון המשפטי הטוב ביותר במינימום סיכונים ובמקסימום תוצאות.
                </p>
              </div>
